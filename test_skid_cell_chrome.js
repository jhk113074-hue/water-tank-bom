...
function startLocalServer() {
  return new Promise((resolve) => {
    ...
    server.listen(8131, () => resolve(server));
  });
}
...
async function run() {
  ...
  console.log('Navigating to http://localhost:8131/#steel-skid-logic ...');
  await page.goto('http://localhost:8131/#steel-skid-logic', { waitUntil: 'networkidle2' });
  ...
  await page.screenshot({ path: path.join(artifactDir, 'test_steel_skid_resizable_cell.png') });
  console.log('Captured test_steel_skid_resizable_cell.png');
