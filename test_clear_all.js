...
function startLocalServer() {
  return new Promise((resolve) => {
    ...
    server.listen(8124, () => resolve(server));
  });
}
...
async function run() {
  ...
  console.log('Navigating to http://localhost:8124/#bom-output ...');
  await page.goto('http://localhost:8124/#bom-output', { waitUntil: 'domcontentloaded' });
  ...
  console.log('Finding and clicking Clear All button...');
  ...
  console.log('Clicked Clear All button:', clicked);
  ...
  console.log('tbodyBOM content:', tbodyHtml);
