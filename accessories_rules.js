  ...
  const AccessoriesRules = {
    ...
    boltsAndNuts: {
      ...
      rows: [
        ...
        { id: "AP67", formula: "RF==1 ? (W_C+W_F-1)*((H_O==1.5||H_O==2)?1:(H_O==2.5||H_O==3)?3:(H_O==3.5||H_O==4)?5:0)*2 : 0", lib: 24, suffix: ["PPD", "PSA4", "PSA4", "PSA4", "PSA2", "PSA4"], label: "Partition Tie-Rods Bracket + Cross Plate", section: "PARTITION BRACKET" },
