  ...
  const AccessoriesRules = {
    ...
    boltsAndNuts: {
      ...
      rows: [
        ...
        { id: "AP66", formula: "RF==1 ? (H_O>1 ? (((W_C+W_F-1)+(L_C+L_F-1-N_PA))*2*2*((H_O==1.5||H_O==2)?1:(H_O==2.5||H_O==3)?3:(H_O==3.5||H_O==4)?5:0)) + (H_O>=2.5?(H_C+H_F-2)*2*N_PA:0) : 0) : 0", lib: 24, suffix: ["PD", "PD", "SA2", "SA2", "SA2", "SA4"], label: "Tie-Rods Bracket + Cross Plate", section: "PARTITION BRACKET" },
        { id: "AP67", formula: "RF==1 ? (W_C+W_F-1)*((H_O==1.5||H_O==2)?1:(H_O==2.5||H_O==3)?3:(H_O==3.5||H_O==4)?5:0)*2 : 0", lib: 24, suffix: ["SA2", "SA4", "SA4", "SA4", "SA2", "SA4"], label: "Partition Tie-Rods Bracket + Cross Plate", section: "PARTITION BRACKET" },
        { id: "AP68", formula: "RF==1 ? (H_O>=3 ? 16*(H_C+H_F-2) : 0) : 0", lib: 24, suffix: ["PD", "PD", "SA2", "SA2", "SA2", "SA4"], label: "WBR-9090 + WCP1610Z at Corner", section: "PARTITION BRACKET" },
