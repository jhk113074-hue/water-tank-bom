  ...
  const AccessoriesRules = {
    ...
    boltsAndNuts: {
      ...
      rows: [
        ...
        { id: "AP12", formula: "(R1*W_C+R05*W_F)*(L_C+L_F-1)", lib: 12, suffix: ["HDG", "HDG", "SA2", "HDG", "SA2", "SA4"], label: "Bottom PNL + Bottom PNL (Vertical)", section: "BOTTOM" },
        { id: "AP13", formula: "L_O*R1*(W_C+W_F-1)", lib: 12, suffix: ["HDG", "HDG", "SA2", "HDG", "SA2", "SA4"], label: "Bottom PNL + Bottom PNL (Horizontal)", section: "BOTTOM" },
        ...
        { id: "AP14", formula: "(L1_C+L2_C+L3_C+L4_C+W_C)*R1*2 + (L1_F+L2_F+L3_F+L4_F+W_F)*R05*2 - AP24", lib: 13, suffix: ["HDG", "HDG", "SA2", "HDG", "SA2", "SA4"], label: "Bottom PNLs + Side PNLs", section: "BOTTOM" },
