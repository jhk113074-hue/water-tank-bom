...
function startLocalServer() {
  return new Promise((resolve) => {
    ...
    server.listen(8243, () => resolve(server));
  });
}
...
async function run() {
  ...
  await page.goto('http://localhost:8243/#bolt-logic-audit', { waitUntil: 'domcontentloaded' });
  ...
  console.log('=== Panel Assembly Bolts for W=2, L1=1, L2=1, H=2 ===');
